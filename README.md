...
PalmExec reads and executes MethodSCRIPTs. Methodscripts give complete control of the Sensit Smart. They are texts that are simple to edit prior to running PalmExec. Scripts permit the sequencing of many electrochemical methods. Once started scripts can run for minutes, hours or days. More on scripts in https://www.palmsens.com/app/uploads/2025/10/MethodSCRIPT-v1_8.pdf Sample scripts for linear sweep voltammetry with chronoamperometry, impedance spectroscopy, open circuit potentiometry and square wave voltammetry are included with PalmExec.
